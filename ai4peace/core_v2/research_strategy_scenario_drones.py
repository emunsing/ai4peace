...
class DroneArmsControlScenario(GameScenario):
    ...
    RESEARCH_TOPICS = [
        ...
        {
            "project_name": "Autonomous Scout Drones",
        ...
        {
            "project_name": "Long-Range Mothership Deployment",
